...
This section specifies the syntactic rules governing subordinate clauses in Interslavic: finite complement clauses, infinitival (and :isv[da]-periphrastic) complements, tense correlation, conditional, purposive, temporal, and concessive/adversative constructions. It also covers compound sentences (coordination), the three subordination connectors, and the universal punctuation rule for complex sentences.
...
:::caution[Unverified Content]
The verb form :isv[pridu] is 1st person singular, but the subject is :isv[ona] (3rd person). Expected form: :isv[pridet] or :isv[pride].
:::

- :isv[Ona skazala, čto ona ne pridu.]
  "She said that she would not come."

- :isv[My znamo, že on byl tamo.]
  "We know that he was there."

Both :isv[že] and :isv[čto] are fully interchangeable as complementizers. :isv[Že] is more characteristic of a North/West Slavic stylistic register; :isv[čto] is more characteristic of East Slavic. Either form is normatively correct.

The complementizer may be omitted in informal or stylistically elevated registers, as in some natural Slavic languages:

- :isv[Věrim, on pridet.] — "I believe he will come." (complementizer omitted)

Omission of the complementizer is optional; the full form with :isv[že] or :isv[čto] is always preferred in formal written usage.
...
- :isv[Ona začela čitati.] — "She began to read."
- :isv[My moramo rabotati.] — "We must work."

The following verb classes regularly govern infinitival complements (same-subject control):

:::caution[Unverified Content]
In the table below, the form :isv[hotetь] uses a Cyrillic soft sign (ь) mixed with Latin script, which is inconsistent. Compare :isv[htěti] in the modal verbs row.
:::

| Verb class | Examples |
|---|---|
| Modal verbs | :isv[moći] "can", :isv[morati] "must", :isv[smět] "may", :isv[htěti] "want to" |
| Phase verbs | :isv[načeti] "begin", :isv[prestati] "stop", :isv[prodolžati] "continue" |
...
:::caution[Unverified Content]
The form :isv[kašem] appears to be a typo for :isv[kažem] ("I say"), as shown in the alternative form on the next line.
:::

- :isv[Htěl jesm kašem.] — "I wanted to say."
  — alternatively: :isv[Htěl jesm da kažem.]

This construction is particularly appropriate in texts addressing South Slavic readers (especially speakers of Bulgarian and Macedonian, which have no infinitive).
...
- :isv[On skazal, že ona jest bolna.]
  "He said that she **is** ill." (present in the embedded clause = still true at speech time)

- :isv[On skazal, že ona była bolna.]
  "He said that she **was** ill." (past in the embedded clause = illness before speech time)

- :isv[On skazal, že ona bųde bolna.]
  "He said that she **will be** ill." (future in the embedded clause = illness after speech time)

Writers SHOULD select the tense that accurately describes the time of the embedded event relative to the moment of speaking, not relative to the main clause tense. Backshift (as obligatory in English "he said she *was* ill" even when still ill) is **not** required and is not part of the Interslavic norm.
...
- :isv[Ako on ima vrěme, on pomože nam.]
...
- :isv[Ako byh ja věděl o tym, ne pošel byh tamo.]
  "If I had known about that, I would not have gone there."

- :isv[Dětę ne plakalo by, ako by go ničto ne bolělo.]
  "The child would not be crying if nothing were hurting it."
...
- :isv[Ako byh byl prišel, ja byh bil viděl to.]
  "If I had come, I would have seen it."
...
- :isv[Turisti posětet Niderlandiju, že by fotografovali tulipany.]
  "Tourists visit the Netherlands **in order to** photograph the tulips."

- :isv[Ona prinosi jabloka, da by děti byli zdrave.]
  "She brings apples **so that** the children will be healthy."
...
- :isv[Prišel sem da ti kažem.]
  "I came **to tell** you." / "I came **so that** I might tell you."

- :isv[Naši prědki sųt sę boroli da bysmo žyvěli ščęstlivo.]
  "Our ancestors fought **so that** we might live happily."
...
|---|---|---|
| :isv[kogda] or :isv[kogdy] | "when" | neutral |
| :isv[dokolě] | "as long as, while" | neutral |
| :isv[dopoka] | "as long as" | neutral |
| :isv[dopoka ne] | "until, till" | neutral |
| :isv[poka] | "while, so far as" | South/East Slavic |
| :isv[jako skoro] | "as soon as" | neutral |
| :isv[odkogda] | "ever since, for as long as" | neutral |

**Examples:**

- :isv[Kogda on pridet, my začnemo.]
  "When he comes, we will begin."

- :isv[Dokolě solnce světit, rabotajmo.]
  "As long as the sun shines, let us work."

- :isv[Čekajte, dopoka ne pridu.]
  "Wait until I come."

:::caution[Unverified Content]
The verb form :isv[pridetu] appears incorrect. Expected :isv[pridet] or :isv[pride] (3rd person singular).
:::

- :isv[Jako skoro ona pridetu, pozvonim.]
  "As soon as she arrives, I will call."

**Aspect and tense in temporal clauses:** When the main clause verb is in the future tense, the temporal clause verb is typically in the **perfective present** (which expresses a completed future event) rather than in an analytic future form. This mirrors the pattern in natural Slavic languages:

- :isv[Kogda on pride (pf. pres.), my pojdemo.] — "When he comes, we will go."
...
| Conjunction | Meaning |
|---|---|
| :isv[hotě] or :isv[hoti] | "although, though, even though" |
| :isv[ače] | "although, though" |
| :isv[vsěako] | "nevertheless, all the same" (concessive adverb) |

- :isv[Hotě on byl ustalen, prodolžal rabotati.]
  "Although he was tired, he continued working."

- :isv[Ače jest zima, děti igrajut vně.]
  "Although it is winter, the children are playing outside."
...
The conjunction **:isv[a]** expresses a milder contrast or shift of topic ("and, but, while"):

- :isv[On pišet, a ona čita.]
  "He writes, while she reads."

The conjunction **:isv[jednako]** ("however, nevertheless") introduces an adversative main clause after a concessive subordinate clause:

- :isv[Hotě jest utomlen, jednako prodolžajet.]
  "Although he is tired, he continues nonetheless."
...
| Type | Conjunction | Meaning |
|---|---|---|
| Copulative | :isv[i] | "and" |
| Copulative (negative) | :isv[ni … ni …] | "neither … nor …" |
| Disjunctive | :isv[ili] | "or" |
| Disjunctive (logical) | :isv[i ili] | "and/or" |
| Adversative | :isv[ale], :isv[no] | "but" |
| Causal | :isv[bo], :isv[zatože] | "because, for" |
| Final/volitional | :isv[da] | "so that, let" |
| Implicative | :isv[ako … potom … inako …] | "if … then … otherwise …" |

**Examples:**

- :isv[Včera je byla velika zima, i my jesmo ostali doma.]
  "Yesterday it was very cold, and we stayed at home."

- :isv[Budete li letěti (samoletom), ili hočete idti autom?]
  "Will you fly (by plane), or do you want to go by car?"

:::caution[Unverified Content]
This example contains :isv[ale no], two adversative conjunctions used together, which appears to be an error. Likely should be :isv[ale] or :isv[no] alone, not both.
:::

- :isv[Jesmo se učili Esperanto, ale no byl to znajemy jezyk.]
  "We studied Esperanto, but it was not a well-known language."

- :isv[Učimo se govoriti medžuslovjanski, bo hočemo razumiti vsim Slovjanam.]
  "We are learning to speak Interslavic, because we want to be understood by all Slavs."

- :isv[Hočemo, da imate dobro vrěme!]
  "We want you to have good weather!"

- :isv[Ako bude dobro vrěme, potom idemo do prirody.]
  "If the weather is good, then we will go to the countryside."

:::note
In Slavic languages the interrogative particle :isv[ako] (or its equivalent) is frequently replaced by a verb in interrogative form. For example: :isv[bude li dobro vrěme] ("will the weather be good?"). This inverted form carries the same conditional meaning as the particle :isv[ako].
:::
...
- :isv[Ne hoču auto, v ktorom jest slaby motor.]
  "I don't want a car in which there is a weak engine." (:isv[auto] ⇐ :isv[ktorom])
...
- :isv[Ne znaju točno, koliko imajemo ljudij.]
  "I don't know exactly how many people we have." (:isv[točno] ⇐ :isv[koliko])

- :isv[Idemo do prirody, kogda je dobro vrěme.]
  "We go to the countryside when the weather is good." (:isv[do prirody] ⇐ :isv[kogda])
...
This rule applies throughout all examples in Merunka's handbook and is used consistently in formal Interslavic prose.

**One comma (two-clause sentence):**

- :isv[Idemo do prirody, kogda bude dobro vrěme.]
  "We will go to the countryside when the weather is good."

  | Part | Clause |
  |---|---|
  | First clause | :isv[Idemo do prirody.] |
  | Second clause | :isv[Kogda bude dobro vrěme.] |

**Two commas (relative clause embedded within main clause):**

- :isv[Moj prijatelj, jegože mlada žena tamo ide, jest bolestny.]
  "My friend, whose young wife is going there, is ill."

  | Part | Clause |
  |---|---|
  | First clause | :isv[Moj prijatelj jest bolestny.] |
  | Embedded clause | :isv[Jegože mlada žena tamo ide.] |
