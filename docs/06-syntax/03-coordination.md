...
Interslavic has the following coordinating conjunctions:

| Conjunction | Meaning / Use |
|---|---|
| :isv[i] | "and" — additive coordination |
| :isv[a] | "and / but" — additive or mild contrastive |
| :isv[ale] | "but" — adversative; corrective contrast |
| :isv[ili] | "or" — disjunctive (inclusive and exclusive) |
| :isv[abo] | "or" — disjunctive (chiefly informal) |
| :isv[no] | "but" — adversative; strong contrast |
| :isv[jednako] | "however" — concessive adversative |
| :isv[pa] | "so / and so" — consecutive |
| :isv[ubo] | "therefore" — illative |
...
Coordinated elements **MUST** belong to the **same syntactic category** (both NPs, both VPs, both APs, both clauses, etc.) or at minimum to compatible grammatical functions within the clause. Coordination of unlike constituents (e.g., an NP conjoined with a PP) is grammatically ill-formed and SHOULD be avoided.

- Grammatical (NP + NP): :isv[otec i mati] — "father and mother"
...
Coordinating conjunctions stand **between** the elements they conjoin. They are invariable (they do not inflect for any grammatical category). When three or more elements are coordinated, the conjunction typically appears only before the final conjunct; earlier conjuncts MAY be separated by commas.

- :isv[knigi, žurnaly i gazety] — "books, magazines and newspapers"
- :isv[On govori, piše i čita.] — "He speaks, writes and reads."
...
Correlative conjunctions work in **pairs**, with the first element appearing before the first conjunct and the second element before the second conjunct. The following correlative pairs are established in Interslavic:
...
- :isv[Ne jedino čita, ale takože piše.] — "Not only reads, but also writes."
...
When two or more NPs are coordinated as the subject of a clause, the finite verb **MUST** agree in the **plural**:

- :isv[Otec i mati sųt doma.] — "Father and mother are at home."
...
When coordinated subjects of mixed grammatical gender govern a compound tense containing an L-participle, the L-participle **MUST** take the **masculine plural** form :isv[-li] as the default resolution.

- :isv[Otec i mati prišli.] — "Father and mother came." (masc. plural default)
- :isv[On i ona kupili sut knigu.] — "He and she have bought a book."

When all coordinated subjects are grammatically feminine, the feminine plural form :isv[-ly] is used:

- :isv[Mati i dočka prišly.] — "Mother and daughter came."

When all coordinated subjects are grammatically neuter, the neuter plural form :isv[-li] is used (neuter plurals share the form with masculine plural for L-participles).
...
- :isv[On čita knigu, ona — žurnal.]
  "He reads a book, she [reads] a magazine."
...
- :isv[Kupil jesm bělų knigu i červenų [knigu].]
  "I bought a white book and a red [book]."

The elided noun's case is preserved on the remaining adjective (:isv[červenų] = accusative feminine singular).
...
**Gapping** is a form of ellipsis specific to coordination in which the **verb** of the second conjunct is omitted when it is identical to the verb of the first conjunct, while non-verbal constituents in the second conjunct are retained.

- :isv[Otec kupil knigu, a syn — žurnal.]
  "Father bought a book, and son [bought] a magazine."

Gapping differs from VP ellipsis in that subject and object of the second conjunct both surface, while only the verb is absent.

:::caution[Unverified Content]
Internal consistency issue: the text refers to :isv[syna] as nominative, but the example above uses :isv[syn] (not :isv[syna]). The form :isv[syna] would typically be genitive or accusative animate, not nominative. The correct nominative form :isv[syn] is used in the example, but the explanatory text below contradicts it.
:::

**Case marking in gapped clauses:** All remaining constituents in the second conjunct **MUST** retain the grammatical case they would bear if the verb were present. In the example above, :isv[syna] would be nominative (subject) and :isv[žurnal] accusative (direct object), which they are.
...
When NPs are coordinated as a single argument of a verb or preposition, all NPs in the conjunction **MUST** bear the same case — the case appropriate to their shared syntactic function.

- :isv[Govorim s otcom i materju.]
  "I speak with father and mother." (both instrumental after :isv[s])

- :isv[Videl jesm brata i sestru.]
  "I saw brother and sister." (both accusative as direct objects; animate :isv[brata], inanimate-pattern :isv[sestru])

Mismatched case within a coordinated NP argument is ungrammatical and MUST NOT occur.
