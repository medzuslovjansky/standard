...
| 3sg present | Imperative stem | 2sg imperative | Gloss |
|---|---|---|---|
| :isv[dělajeт] | :isv[dělaj-] | :isv[dělaj] | do! |
| :isv[umějeт] | :isv[uměj-] | :isv[uměj] | know how! |
| :isv[věrujeт] | :isv[věruj-] | :isv[věruj] | believe! |
| :isv[neseт] | :isv[nes-] | :isv[nesi] | carry! |
| :isv[postaviт] | :isv[postavi-] | :isv[postavi] | put! |
| :isv[pijeт] | :isv[pij-] | :isv[pij] | drink! |
| :isv[myjeт] | :isv[myj-] | :isv[myj] | wash! |

**Consonant alternations before the linking vowel :isv[-i-]:** When the linking vowel :isv[-i-] is added to a stem ending in a velar consonant, **First Palatalization** applies: :isv[k → č], :isv[g → ž], :isv[h → š]. (These alternations apply because the imperative stem is taken from the 3sg, which has already undergone the vowel :isv[-e-] alternation, but the palatal glide trigger in the 2sg ending conditions palatalization of the preceding consonant.)

> :isv[pomožeт] → :isv[pomoži] — "help!"
> :isv[izrěčeт] → :isv[izrěči] — "pronounce! utter!"

**Verbs in :isv[-avati]:** Verbs with the suffix :isv[-va-] in the infinitive form their imperative from the **infinitive stem** with the linking glide :isv[-j-] rather than from the present stem:

> :isv[davati] → :isv[davaj] — "give! (habitual)"
> :isv[sòzdavati] → :isv[sòzdavaj] — "create! (habitual)"

**Irregular imperatives:**

| Verb | Imperative 2sg | Gloss |
|---|---|---|
| :isv[byti] | :isv[bųď] | be! |
| :isv[jěsti] | :isv[jěď] | eat! |
| :isv[věděti] | :isv[věď] | know! |
| :isv[dati] | :isv[daj] | give! |

**Full paradigm of the imperative (three forms):**

The Interslavic imperative has three forms: 2nd person singular, 1st person plural (hortative), and 2nd person plural (plural command or polite singular command). The plural and 1st-plural forms are built by adding :isv[-mo] and :isv[-te] respectively to the 2sg stem:

| | :isv[dati] | :isv[byti] | :isv[davati] | :isv[věriti] | :isv[věrovati] |
|---|---|---|---|---|---|
| 2sg | :isv[daj] | :isv[bųď] | :isv[davaj] | :isv[věri] | :isv[věruj] |
| 1pl | :isv[dajmo] | :isv[bųďmo] | :isv[davajmo] | :isv[věrimo] | :isv[věrujmo] |
| 2pl | :isv[dajte] | :isv[bųďte] | :isv[davajte] | :isv[věrite] | :isv[věrujte] |

**Negation of the imperative:** Negative commands (prohibitions) are formed by placing :isv[ne] before the imperative form:

> :isv[Ne dělaj tego!] — "Don't do that!"
> :isv[Ne bųďte glupi!] — "Don't be foolish!"
...
> :isv[Idemo!] — "Let's go!"
> :isv[Dělajmo!] — "Let's do (it)!"
> :isv[Bųďmo veseli!] — "Let's be merry!"
> :isv[Pijmo za zdorovje!] — "Let's drink to health!"
...
> :isv[Nehaj ona čita.] — "Let her read."
> :isv[Nehaj bųde světlo!] — "Let there be light!"
> :isv[Nehaj oni sami rěšajut.] — "Let them decide for themselves."

The particle :isv[nehaj] is invariable. It may also be used with 1st and 2nd person verbs for stronger optative or permissive nuance, though the imperative forms are more usual in those persons.
...
> :isv[Doždi.] — "It rains / It is raining."
> :isv[Grmi.] — "It thunders."
> :isv[Světaje sę.] — "It is dawning."
...
:::caution[Unverified Content]
The form :isv[Tebu] is suspect. The expected ISV dative of :isv[ty] is :isv[tebě] (or :isv[tebi]). The form :isv[Tebu] does not follow standard ISV pronoun declension patterns.
:::

> :isv[Tebu jest žarko.] — "You are hot." (lit. "To you it is hot.")
> :isv[Jemu jest skučno.] — "He is bored."
...
> :isv[Trěba jest dělati.] — "It is necessary to do / One must do."
> :isv[Nělza idti.] — "It is not permitted to go / One must not go."
> :isv[Nam trěba idti.] — "We need to go." (dative logical subject :isv[nam])

The copula :isv[jest] is frequently omitted: :isv[Možno idti.]
...
:::caution[Unverified Content]
The form :isv[viděliь] contains a Cyrillic soft sign (ь) mixed into an otherwise Latin-script example. This appears to be a character encoding error; the correct form would be :isv[viděli].
:::

> :isv[My viděliь sę.] — "We saw each other."
> :isv[Oni sę borjut.] — "They are fighting each other."
...
> :isv[Kak to dělaje sę?] — "How is that done?"
> :isv[Tuto govori sę po-russki.] — "Russian is spoken here."

In this construction, the nominal participant (if present) may appear as nominative (grammatical subject) or remain implicit. The verb takes the 3sg form in either case. This construction is preferred over the full analytic passive when the agent is unknown or irrelevant.
...
:::caution[Unverified Content]
In the table below, :isv[staraje sę] appears to be a 3sg present-tense form rather than an infinitive. The expected infinitive form would be :isv[starati sę]. All other entries in the table are given in infinitive form.
:::

Typical subject-control verbs include modal and volitional verbs:

| Verb | Gloss |
|---|---|
| :isv[htěti] | to want |
| :isv[moći] | to be able to, can |
| :isv[uměti] | to know how to |
| :isv[načeti] | to begin |
| :isv[prestati] | to stop, cease |
| :isv[staraje sę] | to try |

> :isv[On htěl idti.]
> "He wanted to go." (he = subject of :isv[htěti] = implicit subject of :isv[idti])

> :isv[Ona načela čitati knigu.]
> "She began to read a book." (she = subject of :isv[načeti] = implicit subject of :isv[čitati])
...
| Verb | Gloss | Case of controller |
|---|---|---|
| :isv[prositi] | to ask, request | accusative |
| :isv[zastaviti] | to force, compel | accusative |
| :isv[pozvoliti] | to allow, permit | dative |
| :isv[povelěti] | to command, order | dative |

> :isv[On prosil ju idti.]
> "He asked her to go." (her = object of :isv[prositi] = implicit subject of :isv[idti])

> :isv[Oni zastavili nas rabotati.]
> "They forced us to work." (us = object of :isv[zastaviti] = implicit subject of :isv[rabotati])
...
> "He is ready to go." (:isv[on] is thematically the subject of :isv[idti], not only of :isv[jest])
